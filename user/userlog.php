...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('../img/agric-background.jpeg'); ">
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					Farmer Login
				</span>
				<form class="login100-form validate-form p-b-33 p-t-5" method="post" action="userlog.php">
